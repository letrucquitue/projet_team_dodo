...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 26 Mars 2017 à 09:27
...
(1, 'LePeon', 'Bob', 'bob.lepeon@paysan.w3', '2017-03-25 18:49:00', 0, 0, 'bob', 'François');
...
--
ALTER TABLE `histo_trajet`
  MODIFY `id_histo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `succes`
  MODIFY `id_succes` int(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
