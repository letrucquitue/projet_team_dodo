					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="content">
                <p>Bienvenue sur la page d'administration. Ici vous allez pouvoir insérer de nouveaux succès, de nouveaux moyen de transport et plein de chose en rapport à la base de données !</p>
								</div>
							</div>
						</div>
